...
echo $this->Form->Input('departamento', array('type'=>'select', 'label'=>'Departamento', 'options'=> array('Fundamentos'=>'Fundamentos', 'Políticas'=>'Políticas', 'Métodos'=>'Métodos', 'Interdepartamental' => 'Interdepartamental')));
