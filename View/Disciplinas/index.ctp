...
// Shows the next and previous links
    ...
    <table>
        ...
        foreach ($disciplinas as $c_disciplinas) {
            // pr($c_disciplinas['Planejamento'][$i]);
            // if ($c_disciplinas['Planejamento']['configuraplanejamento_id'] == $semestre_id):
            // die();
            ?>
            <tr>
                ...
                <td>
                    ...
                    foreach ($c_disciplinas['Planejamento'] as $docente_disciplinas):
                        ...
                        if ($docente_disciplinas['configuraplanejamento_id'] == $semestre_id):
